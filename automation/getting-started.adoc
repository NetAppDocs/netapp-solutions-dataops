...
[%collapsible%open]
====
include::../_include/automation-rhel-centos-setup.adoc[tag=steps]
====

.Setup the Ansible Control Node for CLI deployments on Ubuntu / Debian
[%collapsible%open]
====
include::../_include/automation-ubuntu-debian-setup.adoc[tag=steps]
====

.Setup Ansible Tower or AWX for Tower / AWX deployments
[%collapsible%open]
====
include::../_include/setup-awx.adoc[tag=steps]
====
