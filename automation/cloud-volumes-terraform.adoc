...
[%collapsible%open]
====
include::../_include/cloud-volumes-aws.adoc[]
====

.Azure
[%collapsible%open]
====
include::../_include/cloud-volumes-azure.adoc[]
====

.GCP
[%collapsible%open]
====
include::../_include/cloud-volumes-gcp.adoc[]
====


// NetApp Solutions restructuring (jul 2025) - renamed from automation/cloud_volumes_terraform.adoc
