...
+
image:fsxn-monitoring-resizing-ses-smtp-creds-add.png[This image depicts the Create SMTP Credentials window under AWS SES]
=====
...
---- 
+
image:fsxn-monitoring-resizing-create-cft-001.png[This image depicts AWS CloudFormation Create Stack window]
+
Click on Next
...
+
image:fsxn-monitoring-resizing-cft-stack-details-001.png[This image depicts AWS CloudFormation Stack Details window]
+
image:fsxn-monitoring-resizing-cft-stack-details-002.png[This image depicts AWS CloudFormation Stack Details window]
+
image:fsxn-monitoring-resizing-cft-stack-details-003.png[This image depicts AWS CloudFormation Stack Details window]
+
image:fsxn-monitoring-resizing-cft-stack-details-004.png[This image depicts AWS CloudFormation Stack Details window]
...
+
image:fsxn-monitoring-resizing-email-001.png[This image depicts the Email Notification received when notifications are available]
+
image:fsxn-monitoring-resizing-email-002.png[This image depicts the Email Notification received when notifications are available]
=====
...
+
image:fsxn-monitoring-resizing-vpc-endpoint-create-001.png[This image depicts the VPC endpoint creation window]
+
image:fsxn-monitoring-resizing-vpc-endpoint-create-002.png[This image depicts the VPC endpoint creation window]
...
+
image:fsxn-monitoring-resizing-lambda-creation-001.png[This image depicts the Lambda creation window on AWS console.]
+
image:fsxn-monitoring-resizing-lambda-creation-002.png[This image depicts the Lambda creation window on AWS console.]
...
// NetApp Solutions restructuring (jul 2025) - renamed from automation/fsxn_monitoring_resizing_automation.adoc
