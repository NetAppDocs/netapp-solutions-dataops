...
image:access-keys.png[Refresh Token]
...
image:token-authentication.png[Refresh Token]
...
// NetApp Solutions restructuring (jul 2025) - renamed from automation/authentication_tokens.adoc
