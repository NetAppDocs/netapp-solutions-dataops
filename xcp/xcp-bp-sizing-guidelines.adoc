...
image:xcp-bp-010.png["Figure showing input/output dialog or representing written content"]

The following figure shows the results of the XCP Sync rename and link operations.

image:xcp-bp-008.png["Figure showing input/output dialog or representing written content"]
...
image:xcp-bp-009.png["Figure showing input/output dialog or representing written content"]
...
image:xcp-bp-011.png["Figure showing input/output dialog or representing written content"]
...
image:xcp-bp-012.png["Figure showing input/output dialog or representing written content"]
...
image:xcp-bp-013.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from xcp/xcp-bp-sizing-guidelines-overview.adoc
