...
image:xcp-bp-003.png["Figure showing input/output dialog or representing written content"]
...
image:xcp-bp-004.png["Figure showing input/output dialog or representing written content"]
...
image:xcp-bp-005.png["Figure showing input/output dialog or representing written content"]

You can use a similar architecture with the respective components from the various cloud service providers.


// NetApp Solutions restructuring (jul 2025) - renamed from xcp/xcp-bp-migration-workflow-overview.adoc
