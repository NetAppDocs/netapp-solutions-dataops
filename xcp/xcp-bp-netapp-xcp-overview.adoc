...
image:xcp-bp-001.png["Figure showing input/output dialog or representing written content"]
...
image:xcp-bp-002.png["Figure showing input/output dialog or representing written content"]
...
. Create one NFS share on-premises for each Azure NetApp volume or for the Google Cloud NetApp Volumes (premium service level) in cloud for the XCP catalog.
