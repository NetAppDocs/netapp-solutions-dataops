...
For detailed steps on moving MapR-FS data into ONTAP NFS by using NetApp XCP, see Appendix A: GPFS to NFS―Detailed Steps link:https://docs.netapp.com/us-en/netapp-solutions-ai/data-analytics/bda-ai-introduction.html[here^].


// NetApp Solutions restructuring (jul 2025) - renamed from xcp/xcp-bp-high-performance-computing-to-ontap-nfs.adoc
