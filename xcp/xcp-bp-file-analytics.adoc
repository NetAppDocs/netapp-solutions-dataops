...
image:xcp-bp-006.png["Figure showing input/output dialog or representing written content"]
...
image:xcp-bp-007.png["Figure showing input/output dialog or representing written content"]
