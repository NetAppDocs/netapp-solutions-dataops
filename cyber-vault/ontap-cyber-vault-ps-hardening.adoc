...
. Protect administration with multi-admin verification (MAV) in addition to multifactor authentication (MFA), enhancing security for administrative access to the data storage VM.
...
// NetApp Solutions restructuring (jul 2025) - renamed from cyber-vault/ontap-cyber-vault-powershell-hardening.adoc
